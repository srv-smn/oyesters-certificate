...
contract Certificate {
    ...
    function Certificate() public {
     ...
     function createData( string _id  , string _sname , string _course, string _imghash) public restricted {
    ...
    function getData(string _id) public view returns (string , string , string, string) {
